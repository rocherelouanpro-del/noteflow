...
export default function HabitsPage() {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto px-10 py-12">
        ...
        <div className="flex items-center rounded-lg border border-line overflow-hidden">
          {PERIODS.map((p) => (
            <button
              ...
              className={`px-3 py-1.5 text-[13px] font-medium border-r border-line last:border-r-0 transition-colors ${
      ...
      <section className="mb-12">
        ...
        {habits.length === 0 && (
          <p className="text-sm text-ink-faint">
            Aucune habitude. Ajoutez-en une depuis le journal ci-dessous.
          </p>
        )}
      ...
      {/* Journal quotidien (limité à la période) */}
      <section>
        <div className="flex items-center justify-between mb-4">
          ...
          {adding ? (
            <div className="flex items-center gap-2">
              <input
                ...
                className="border border-line rounded-md px-2.5 py-1.5 text-[13px] outline-none focus:border-accent/60 w-52"
              />
              <button
                onClick={submitHabit}
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-md text-[13px] font-medium border border-line text-ink-light hover:bg-hover"
            >
